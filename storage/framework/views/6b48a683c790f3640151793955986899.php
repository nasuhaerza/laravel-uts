...
<head>
    ...
    <style>
        body {
            min-height: 100vh;
            background: linear-gradient(135deg, #800000, #4169e1);
            display: flex;
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card-footer text-center text-muted small py-3">
                    &copy; <?php echo e(date('Y')); ?> Sistem Inventory
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH D:\NASUHA ERZA\PWL\uts_laravel\resources\views/login/index.blade.php ENDPATH**/ ?>