        ...
        <div class="row">
            ...
            <aside class="col-12 col-md-3 col-lg-2 bg-white border-end shadow-sm p-3 min-vh-100">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2">
                        <a href="<?php echo e(route('brg')); ?>" class="nav-link text-dark">Barang</a>
                    </li>
                </ul>
            </aside>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm rounded-3">
                            <div class="card-body">
                                <h6 class="text-muted">Total Barang Inventory</h6>
                    ...
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm rounded-3">
                            <div class="card-body">
                                <h6 class="text-muted">Total Barang Terjual</h6>
                                <h3 class="fw-bold text-success">70</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm rounded-3">
                            <div class="card-body">
                                <h6 class="text-muted">Barang Tersisa</h6>
...
</html><?php /**PATH D:\NASUHA ERZA\PWL\uts_laravel\resources\views/backend/dashboard/index.blade.php ENDPATH**/ ?>